    ...
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      <div className="w-full grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4 pt-5 gap-y-6 px-3 sm:px-0">
        {doctors.slice(0, 10).map((item, index) => (
          ...
          >
            <img className="bg-blue-300 hover:bg-slate-400" src={item.image} alt="" />
            <div className="p-4">
      ...
      <button onClick={()=> {navigate('/doctors')}} className="bg-blue-100 text-gray-700 px-12 py-3 rounded-full mt-10">
        more
      </button>
    </div>
  );
